    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <GlassCard>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-slate-400 font-mono">CHARACTERS CREATED</p>
              <h3 className="text-2xl font-extrabold text-pink-400 mt-1">{analytics?.total_characters || 0}</h3>
            </div>
        ...
        <GlassCard>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-slate-400 font-mono">COMPLETED RENDERS</p>
              <h3 className="text-2xl font-extrabold text-emerald-400 mt-1">{analytics?.completed_renders || 0}</h3>
            </div>
